...
const Map<String, String> _myanmar = {
  ...
  'Unable to share the SKU CSV file.': 'SKU CSV ဖိုင်ကို မျှဝေ၍မရပါ။',
  ...
  'No receivable records found.': 'ပစ္စည်းလက်ခံမှတ်တမ်း မတွေ့ပါ။',
  ...
  'Please confirm these receivable records before applying bulk action.': 'အစုလိုက်လုပ်ဆောင်မှုမပြုမီ လက်ခံမှတ်တမ်းများကို အတည်ပြုပါ။',
  'Please confirm these receivable records before submitting.': 'မတင်ပြမီ လက်ခံမှတ်တမ်းများကို အတည်ပြုပါ။',
  ...
  'Receivable': 'ပစ္စည်းလက်ခံခြင်း',
  'Receivable Backlog': 'ပစ္စည်းလက်ခံမှု ကျန်ရှိစာရင်း',
  'Receivable Checklist': 'ပစ္စည်းလက်ခံ စစ်ဆေးစာရင်း',
  'Receivable Records': 'ပစ္စည်းလက်ခံမှတ်တမ်းများ',
  'Receivable Review': 'ပစ္စည်းလက်ခံမှု စစ်ဆေးရန်',
  'Receivable record approved': 'ပစ္စည်းလက်ခံမှတ်တမ်း အတည်ပြုပြီး',
  'Receivable record rejected': 'ပစ္စည်းလက်ခံမှတ်တမ်း ပယ်ချပြီး',
  'Receivable records approved': 'ပစ္စည်းလက်ခံမှတ်တမ်းများ အတည်ပြုပြီး',
  'Receivable records rejected': 'ပစ္စည်းလက်ခံမှတ်တမ်းများ ပယ်ချပြီး',
  'Report': 'အစီရင်ခံစာ',
  'Daily Photos': 'နေ့စဉ်ဓာတ်ပုံများ',
  'Photos Taken': 'ရိုက်ထားသောဓာတ်ပုံများ',
  'Receivable submitted': 'ပစ္စည်းလက်ခံမှု တင်ပြပြီး',
  ...
  'Review daily counts and receivable records.': 'နေ့စဉ်ရေတွက်မှုနှင့် ပစ္စည်းလက်ခံမှတ်တမ်းများကို စစ်ဆေးပါ။',
  ...
  'Search receivable': 'ပစ္စည်းလက်ခံမှု ရှာရန်',
  ...
  'Number of Staff on Duty': 'တာဝန်ကျ ဝန်ထမ်းဦးရေ',
  ...
  'Submitted receivable': 'ကုန်လက်ခံမှု တင်ပြခဲ့သည်',
  'Reviewed receivable': 'ကုန်လက်ခံမှု စစ်ဆေးခဲ့သည်',
  ...
  'Approve Receivable Record?': 'ကုန်လက်ခံမှတ်တမ်းကို အတည်ပြုမည်လား။',
  'Reject Receivable Record?': 'ကုန်လက်ခံမှတ်တမ်းကို ပယ်ချမည်လား။',
  ...
  'Share SKU Export': 'SKU ထုတ်ယူမှု မျှဝေရန်',
  ...
  'Select Cash Received By.': 'ငွေလက်ခံသူကို ရွေးပါ။',
  'Number of Staff on Duty must be between 1 and 500.':
      'တာဝန်ကျ ဝန်ထမ်းဦးရေသည် ၁ မှ ၅၀၀ အတွင်း ဖြစ်ရမည်။',
  ...
  'Comment & Review': 'မှတ်ချက်ရေး၍ စစ်ဆေးရန်',
  'Approve this Report?': 'ဤအစီရင်ခံစာကို အတည်ပြုမည်လား။',
  'Cash Sales': 'ငွေသား ရောင်းအား',
  'eWallet Sales': 'eWallet ရောင်းအား',
  'Void Summary': 'ပယ်ဖျက်ဘေလ် အကျဉ်းချုပ်',
  'Review Comment': 'စစ်ဆေးမှတ်ချက်',
  'No review comment.': 'စစ်ဆေးမှတ်ချက် မရှိပါ။',
  ...
  'Submit Receivable?': 'ကုန်လက်ခံမှု တင်ပြမည်လား။',
  'This will create the receivable record and update the received SKU balances.':
...
const Map<String, String> _chinese = {
  ...
  'Unable to share the SKU CSV file.': '无法分享SKU CSV文件。',
  ...
  'No receivable records found.': '找不到收货记录。',
  ...
  'Please confirm these receivable records before applying bulk action.': '批量操作前，请确认这些收货记录。',
  'Please confirm these receivable records before submitting.': '提交前，请确认这些收货记录。',
  ...
  'Received Qty': '收货数量',
  'Receivable': '收货',
  'Receivable Backlog': '收货待处理',
  'Receivable Checklist': '收货检查清单',
  'Receivable Records': '收货记录',
  'Receivable Review': '收货审核',
  'Receivable record approved': '收货记录已批准',
  'Receivable record rejected': '收货记录已拒绝',
  'Receivable records approved': '收货记录已批准',
  'Receivable records rejected': '收货记录已拒绝',
  'Report': '报告',
  'Daily Photos': '每日照片',
  'Photos Taken': '已拍照片',
  'Receivable submitted': '收货记录已提交',
  ...
  'Review daily counts and receivable records.': '审核每日盘点及收货记录。',
  ...
  'Review submitted receivable records': '审核已提交的收货记录',
  ...
  'Total Sales': '总销售额',
  'Number of Staff on Duty': '当值员工人数',
  ...
  'Submitted receivable': '已提交收货记录',
  'Reviewed receivable': '已审核收货记录',
  ...
  'Approve Receivable Record?': '批准收货记录？',
  'Reject Receivable Record?': '拒绝收货记录？',
  'This will update the review status of this receivable record.':
      '这将更新此收货记录的审核状态。',
  ...
  'Payment totals must be valid non-negative amounts.':
      '付款总额必须是有效的非负金额。',
  'Select Cash Received By.': '请选择现金接收人。',
  'Number of Staff on Duty must be between 1 and 500.':
      '当值员工人数必须介于1至500人。',
  'Finish recording this void bill, or clear the optional fields before submitting Sales.':
  ...
  'Comment & Review': '评论与审核',
  'Approve this Report?': '批准此报告？',
  'Cash Sales': '现金销售额',
  'eWallet Sales': '电子钱包销售额',
  'Void Summary': '作废账单摘要',
  'Review Comment': '审核意见',
  'No review comment.': '未填写审核意见。',
  'Approve Report': '批准报告',
  'Reject Report': '拒绝报告',
